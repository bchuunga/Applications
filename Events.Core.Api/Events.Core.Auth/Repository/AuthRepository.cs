using Events.Core.Auth.Constants;
using Events.Core.Auth.Dtos;
using Events.Core.Auth.Identity.Interface;
using Events.Core.Auth.Models;
using Events.Core.Auth.Repository.Interface;
using Microsoft.AspNetCore.Identity;

namespace Events.Core.Auth.Repository
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public async Task<ResponseDto> Register(RegistrationRequestDto registerDto)
        {
            ...
            if (result.Succeeded)
            {
                registerDto.Roles.Add(MeetupCoreAuthRoles.UserRole);

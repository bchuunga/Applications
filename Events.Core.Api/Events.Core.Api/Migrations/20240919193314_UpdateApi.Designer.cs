...
namespace Events.Core.Api.Migrations
{
    ...
    [Migration("20240919193314_UpdateApi")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Events.Core.Api.Models.Meetup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2024, 9, 29, 15, 33, 13, 87, DateTimeKind.Local).AddTicks(7527),
                            IsPrivate = true,
                            Name = "Dot Net Users",
                            Organizer = "Microsoft"
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = new Guid("0b1b9bc2-4e6d-4096-8295-29e91ce47fce"),
                            Date = new DateTime(2024, 9, 20, 15, 33, 13, 87, DateTimeKind.Local).AddTicks(7593),
                            IsPrivate = true,
                            Name = "SQL Users",
                            Organizer = "Microsoft"
                        },
                        new
                        {
                            Id = 3,
                            CreatedBy = new Guid("0b1b9bc2-4e6d-4096-8295-29e91ce47fce"),
                            Date = new DateTime(2024, 10, 11, 15, 33, 13, 87, DateTimeKind.Local).AddTicks(7597),
                            IsPrivate = false,
                            Name = "Code Campers",
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = new Guid("0b1b9bc2-4e6d-4096-8295-29e91ce47fce"),
                            Date = new DateTime(2024, 12, 28, 15, 33, 13, 87, DateTimeKind.Local).AddTicks(7601),
                            IsPrivate = true,
                            Name = "Wine Lovers",
            ...
            modelBuilder.Entity("Events.Core.Api.Models.Lecture", b =>
                {
                    b.HasOne("Events.Core.Api.Models.Meetup", "Meetup")
                        .WithMany("Lectures")
